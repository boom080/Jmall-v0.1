...
from app.api import agent, catalog, health, images, knowledge_bases, mock_ai, product_copy, shopper
...
app.include_router(shopper.router, prefix=settings.api_prefix)
